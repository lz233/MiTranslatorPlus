    ...
    private fun showSettingsDialog() {
        ...
        dialogBuilder.setView(ScrollView(Config.context).apply {
            ...
            addView(LinearLayout(Config.context).apply {
                ...
                addView(FuckSwitch.FastBuilder(mText = "白名单模式", mKey = "whileListMode").build())
                addView(FuckEditText.FastBuilder(mHint = "为 JSON 数组，如 [\"org.lsposed.manager\"]，白名单模式下生效。", mKey = "whileAppList").build())
