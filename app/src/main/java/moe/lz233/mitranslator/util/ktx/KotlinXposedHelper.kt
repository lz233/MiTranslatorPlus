...
inline fun String.hookBeforeAllMethods(method: String?, classLoader: ClassLoader = Config.classLoader, crossinline hooker: (MethodHookParam) -> Unit) = try {
    findClass(classLoader).hookBeforeAllMethods(method, hooker = hooker)
} catch (e: ClassNotFoundError) {
    LogUtil.e(e)
    null
} catch (e: ClassNotFoundException) {
...
inline fun String.hookAfterAllMethods(method: String?, classLoader: ClassLoader = Config.classLoader, crossinline hooker: (MethodHookParam) -> Unit) = try {
    findClass(classLoader).hookAfterAllMethods(method, hooker = hooker)
} catch (e: ClassNotFoundError) {
    LogUtil.e(e)
    null
} catch (e: ClassNotFoundException) {
...
inline fun String.hookBeforeConstructor(vararg args: Any?, classLoader: ClassLoader = Config.classLoader, crossinline hooker: (MethodHookParam) -> Unit) = findClass(classLoader).hookConstructor(*args, object : XC_MethodHook() {
    override fun beforeHookedMethod(param: MethodHookParam) {
        try {
            hooker(param)
        } catch (e: Throwable) {
...
inline fun String.replaceConstructor(vararg args: Any?, classLoader: ClassLoader = Config.classLoader, crossinline hooker: (MethodHookParam) -> Unit) = findClass(classLoader).hookConstructor(*args, object : XC_MethodReplacement() {
    override fun replaceHookedMethod(param: MethodHookParam) {
        try {
            hooker(param)
        } catch (e: Throwable) {
